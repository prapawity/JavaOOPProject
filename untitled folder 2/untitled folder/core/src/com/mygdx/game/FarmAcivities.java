        ...
        private void activity(int index,int mouseNumber,FloorStatus[] floorMaps,ArrayList<SlotBag> slotBags,MouseChange mouseChange){
            if (mouseNumber==3) {
                if(floorMaps[index].getStatus()==0) {
                    floorMaps[index].setName("GenerateMap/dicking.png");
                ...
                if(!floorMaps[index].getTree().getNameTree().equals("GenerateMap/null.png") & !floorMaps[index].getTree().getNameTree().equals("GenerateMap/deadtree.png")){
                    floorMaps[index].getTree().setNameTree("GenerateMap/deadtree.png");
                    floorMaps[index].getTree().setGrowthStatus(0);
                }
                else if(floorMaps[index].getTree().getNameTree().equals("GenerateMap/deadtree.png")){
                    floorMaps[index].getTree().setNameTree("GenerateMap/null.png");
                    floorMaps[index].getTree().setGrowthStatus(0);
                ...
                if(floorMaps[index].getStatus()==0){
                    floorMaps[index].setName("GenerateMap/wetfloor.png");
                    floorMaps[index].setStatus(2);
                }
                else if(floorMaps[index].getStatus()==1){
                    floorMaps[index].setName("GenerateMap/dickingwet.png");
                    floorMaps[index].setStatus(4);
                }
                if(!floorMaps[index].getTree().getNameTree().equals("GenerateMap/null.png"))floorMaps[index].getTree().addGrowth(5);
            }
            else if(mouseNumber==7 && floorMaps[index].getTree().getNameTree().equals("GenerateMap/null.png")){
                if(slotBags.get(0).getName().equals("GenerateMap/tree/10/bag.png")){
                    floorMaps[index].getTree().setNameTree("GenerateMap/tree/10/1.png");
                }
                else if(slotBags.get(0).getName().equals("GenerateMap/tree/2/bag.png")){
                    floorMaps[index].getTree().setNameTree("GenerateMap/tree/2/1.png");
                }
                else if(slotBags.get(0).getName().equals("GenerateMap/tree/11/bag.png")){
                    floorMaps[index].getTree().setNameTree("GenerateMap/tree/11/1.png");
                }
                else if(slotBags.get(0).getName().equals("GenerateMap/tree/12/bag.png")){
                    floorMaps[index].getTree().setNameTree("GenerateMap/tree/12/1.png");
                }
                else if(slotBags.get(0).getName().equals("GenerateMap/tree/13/bag.png")){
                    floorMaps[index].getTree().setNameTree("GenerateMap/tree/13/1.png");
                }
            ...
            else if(mouseNumber==10 && floorMaps[index].getTree().getNameTree().equals("GenerateMap/null.png")){
                if(slotBags.get(1).getName().equals(Gdx.files.internal("GenerateMap/tree/10/bag.png").toString())){
                    floorMaps[index].getTree().setNameTree("GenerateMap/tree/10/1.png");
                    floorMaps[index].getTree().setGrowthStatus(0);
                }
                else if(slotBags.get(1).getName().equals("GenerateMap/tree/2/bag.png")){
                    floorMaps[index].getTree().setNameTree("GenerateMap/tree/2/1.png");
                    floorMaps[index].getTree().setGrowthStatus(0);
                }
                else if(slotBags.get(1).getName().equals("GenerateMap/tree/11/bag.png")){
                    floorMaps[index].getTree().setNameTree("GenerateMap/tree/11/1.png");
                    floorMaps[index].getTree().setGrowthStatus(0);
                }
                else if(slotBags.get(1).getName().equals("GenerateMap/tree/12/bag.png")){
                    floorMaps[index].getTree().setNameTree("GenerateMap/tree/12/1.png");
                    floorMaps[index].getTree().setGrowthStatus(0);
                }
                else if(slotBags.get(1).getName().equals("GenerateMap/tree/13/bag.png")){
                    floorMaps[index].getTree().setNameTree("GenerateMap/tree/13/1.png");
                    floorMaps[index].getTree().setGrowthStatus(0);
                }
                if(floorMaps[index].getStatus()>2)floorMaps[index].getTree().setGrowthStatus(5);
            ...
            else if(mouseNumber==11 && floorMaps[index].getTree().getNameTree().equals("GenerateMap/null.png")){
                if(slotBags.get(2).getName().equals("GenerateMap/tree/10/bag.png")){
                    floorMaps[index].getTree().setNameTree("GenerateMap/tree/10/1.png");
                    floorMaps[index].getTree().setGrowthStatus(0);
                }
                else if(slotBags.get(2).getName().equals("GenerateMap/tree/2/bag.png")){
                    floorMaps[index].getTree().setNameTree("GenerateMap/tree/2/1.png");
                    floorMaps[index].getTree().setGrowthStatus(0);
                }
                else if(slotBags.get(2).getName().equals("GenerateMap/tree/11/bag.png")){
                    floorMaps[index].getTree().setNameTree("GenerateMap/tree/11/1.png");
                    floorMaps[index].getTree().setGrowthStatus(0);
                }
                else if(slotBags.get(2).getName().equals("GenerateMap/tree/12/bag.png")){
                    floorMaps[index].getTree().setNameTree("GenerateMap/tree/12/1.png");
                    floorMaps[index].getTree().setGrowthStatus(0);
                }
                else if(slotBags.get(2).getName().equals("GenerateMap/tree/13/bag.png")){
                    floorMaps[index].getTree().setNameTree("GenerateMap/tree/13/1.png");
                    floorMaps[index].getTree().setGrowthStatus(0);
                }
                if(floorMaps[index].getStatus()>2)floorMaps[index].getTree().setGrowthStatus(5);
            ...
            else if(mouseNumber==12 && floorMaps[index].getTree().getNameTree().equals("GenerateMap/null.png")){
                if(slotBags.get(3).getName().equals("GenerateMap/tree/10/bag.png")){
                    floorMaps[index].getTree().setNameTree("GenerateMap/tree/10/1.png");
                    floorMaps[index].getTree().setGrowthStatus(0);
                }
                else if(slotBags.get(3).getName().equals("GenerateMap/tree/2/bag.png")){
                    floorMaps[index].getTree().setNameTree("GenerateMap/tree/2/1.png");
                    floorMaps[index].getTree().setGrowthStatus(0);
                }
                else if(slotBags.get(3).getName().equals("GenerateMap/tree/11/bag.png")){
                    floorMaps[index].getTree().setNameTree("GenerateMap/tree/11/1.png");
                    floorMaps[index].getTree().setGrowthStatus(0);
                }
                else if(slotBags.get(3).getName().equals("GenerateMap/tree/12/bag.png")){
                    floorMaps[index].getTree().setNameTree("GenerateMap/tree/12/1.png");
                    floorMaps[index].getTree().setGrowthStatus(0);
                }
                else if(slotBags.get(3).getName().equals("GenerateMap/tree/13/bag.png")){
                    floorMaps[index].getTree().setNameTree("GenerateMap/tree/13/1.png");
                    floorMaps[index].getTree().setGrowthStatus(0);
                }
                if(floorMaps[index].getStatus()>2)floorMaps[index].getTree().setGrowthStatus(5);
